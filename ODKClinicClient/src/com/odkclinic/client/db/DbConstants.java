...
public class DbConstants {
	...
	public static int NOTES_CONCEPT_ID = 5097; //TODO: fix dependency on this
    /**
     * Triggers
     */
    ...
    public static final String  ENCOUNTER_HISTORY_QUERY = 
        ...
        public static final String[] DEFAULT_VALUES = 
        {
        	...
        	"INSERT INTO patient(patient_id,gender,race,birthdate,patient_name) VALUES(2,'FEMALE','Asian','1977-01-02','Michelle'); ",
        	"INSERT INTO cohort(cohort_id,name,creator,voided,date_created) VALUES(1,'PRIME',1,0,'2009-06-02 00:00:00'); ",
        	...
        	"INSERT INTO concept(concept_id,class_id,concept_datatype_id,is_set,retired,creator,date_created,voided) VALUES(1,1,1,1,0,1,'2009-01-01 00:00:00',0); ",
        	"INSERT INTO concept(concept_id,class_id,concept_datatype_id,is_set,retired,creator,date_created,voided) VALUES(2,1,2,1,0,1,'2009-01-01 00:00:00',0); ",
        	"INSERT INTO concept(concept_id,class_id,concept_datatype_id,is_set,retired,creator,date_created,voided) VALUES(3,1,3,1,0,1,'2009-01-01 00:00:00',0); ",
        	"INSERT INTO concept(concept_id,class_id,concept_datatype_id,is_set,retired,creator,date_created,voided) VALUES(4,1,4,1,0,1,'2009-01-01 00:00:00',0); ",
        	...
        	"INSERT INTO client_encounter(encounter_id,encounter_patient_id,encounter_provider_id,encounter_location_id,encounter_datetime,creator,date_created,voided,isUpdate) VALUES(1,1,1,1,'2009-10-28 00:00:00',1,'2009-10-28 00:00:00',0, 1); ",
        	"INSERT INTO client_encounter(encounter_id,encounter_patient_id,encounter_provider_id,encounter_location_id,encounter_datetime,creator,date_created,voided,isUpdate) VALUES(2,2,1,1,'2009-10-28 00:00:00',1,'2009-10-28 00:00:00',0, 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_numeric,creator,voided,observation_date_created,isUpdate) VALUES(1,1,4,1,100,1,0,'2009-07-23 00:00:00', 1); ",
        	...
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_numeric,creator,voided,observation_date_created,isUpdate) VALUES(8,1,3,1,500,1,0,'2009-01-23 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_numeric,creator,voided,observation_date_created,isUpdate) VALUES(9,1,3,1,600,1,0,'2009-03-24 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_numeric,creator,voided,observation_date_created,isUpdate) VALUES(10,1,3,1,520,1,0,'2009-05-23 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_numeric,creator,voided,observation_date_created,isUpdate) VALUES(11,1,3,1,550,1,0,'2009-07-24 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_numeric,creator,voided,observation_date_created,isUpdate) VALUES(12,2,3,2,500,1,0,'2009-01-25 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_numeric,creator,voided,observation_date_created,isUpdate) VALUES(13,2,3,2,700,1,0,'2009-03-02 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_numeric,creator,voided,observation_date_created,isUpdate) VALUES(14,2,3,2,900,1,0,'2009-06-05 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_text,creator,voided,observation_date_created,isUpdate) VALUES(15,1,2,1,'This Patient is WOW',1,0,'2009-07-23 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_text,creator,voided,observation_date_created,isUpdate) VALUES(16,1,2,1,'WOW a note?',1,0,'2009-03-23 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_text,creator,voided,observation_date_created,isUpdate) VALUES(17,1,2,1,'Hmm___',1,0,'2009-01-21 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_text,creator,voided,observation_date_created,isUpdate) VALUES(18,1,2,1,'Hootie Hoo!',1,0,'2009-05-23 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_text,creator,voided,observation_date_created,isUpdate) VALUES(19,2,2,2,'Dude_',1,0,'2009-01-25 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_text,creator,voided,observation_date_created,isUpdate) VALUES(20,2,2,2,'How ___',1,0,'2009-03-26 00:00:00', 1); ",
        	"INSERT INTO client_observation(obs_id,observation_patient_id,observation_concept_id,observation_encounter_id,value_text,creator,voided,observation_date_created,isUpdate) VALUES(21,2,2,2,'Oh god why??!',1,0,'2009-06-32 00:00:00', 1); ",
        	...
        	"INSERT INTO patient(patient_id,gender,race,birthdate,patient_name) VALUES(3,'MALE','Asian','1988-10-28 00:00:00','Zell'); ",
        	"INSERT INTO patient(patient_id,gender,race,birthdate,patient_name) VALUES(4,'FEMALE','Asian','1987-01-02 00:00:00','Michiko'); ",
        	"INSERT INTO cohort(cohort_id,name,creator,voided,date_created) VALUES(2,'PRIME',1,0,'2009-06-02 00:00:00'); ",
